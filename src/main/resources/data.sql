...
INSERT INTO colaborador (cpf, data_cadastro, email, nome, time_id)
VALUES ('45678901233', CURRENT_DATE - INTERVAL '28' DAY, 'user4@example.com', 'Ana Souza', 2);

INSERT INTO colaborador (cpf, data_cadastro, email, nome, time_id)
VALUES ('56789012344', CURRENT_DATE - INTERVAL '35' DAY, 'user5@example.com', 'Lucas Pereira', 2);

INSERT INTO colaborador (cpf, data_cadastro, email, nome, time_id)
VALUES ('67890123455', CURRENT_DATE - INTERVAL '42' DAY, 'user6@example.com', 'Carolina Santos', 1);

INSERT INTO colaborador (cpf, data_cadastro, email, nome, time_id)
VALUES ('78901234566', CURRENT_DATE - INTERVAL '49' DAY, 'user7@example.com', 'Rodrigo Almeida', 3);

INSERT INTO colaborador (cpf, data_cadastro, email, nome, time_id)
VALUES ('89012345677', CURRENT_DATE - INTERVAL '56' DAY, 'user8@example.com', 'Larissa Rodrigues', 3);
